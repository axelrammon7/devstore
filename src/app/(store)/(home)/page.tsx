  ...
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
      <Link href={`/product/${highlightedProduct.slug}`} className="group relative col-span-6 row-span-6 rounded-lg bg-zinc-900 overflow-hidden flex justify-center items-end">
        ...
        <div className="absolute bottom-28 right-28 h-12 flex items-center gap-2 ma-w-[280px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
      ...
      {otherProducts.map(product => {
        return (
          ...
          >
            ...
            <div className="absolute bottom-10 right-10 h-12 flex items-center gap-2 ma-w-[280px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
